...
from data_prepare.data.prepare.qm9 import download_dataset_qm9
from data_prepare.data.prepare.zinc import process_dataset_zinc
...
def prepare_dataset(datadir, dataset, subset=None, splits=None, cleanup=False, force_download=False):
    ...
    if new_download or force_download:
        ...
        elif dataset.lower().startswith('zinc'):
            process_dataset_zinc(datadir, dataset, splits)
...
if __name__ == '__main__':
    prepare_dataset('final_xyz_folder', 'zinc')
